...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6aa25d0ce0636cc826ff820d03f5af03) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Rrd_idl"; "Rrd_rpc_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "xcp";
                      lib_findlib_name = Some "rrd_ppx";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "rrd_cli.ml"});
               Library
                 ({
                     cs_name = "xcp_xen";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "E\231\162\175)\208H\156\169K[\012?\011\238\240";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
